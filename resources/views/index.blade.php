...
<main class="content">
	...
	<section id="home" class="home d-flex align-items-center">
		<div class="container">
			...
			<div class="intro">
				<!-- avatar image -->
				<img src="images/p1.png" alt="Bolby" class="mb-4" />

				<!-- info -->
				<h1 class="mb-2 mt-0">Farooq Akram</h1>
				<span>I'm a <span class="text-rotating">PHP Developer, WordPress Developer, IoT Lover</span></span>

				<!-- social icons -->
				<ul class="social-icons light list-inline mb-0 mt-4">
					<li class="list-inline-item"><a href="#"><i class="fab fa-php"></i></a></li>
					<li class="list-inline-item"><a href="#"><i class="fab fa-wordpress"></i></a></li>
					<li class="list-inline-item"><a href="#"><i class="fab fa-css3"></i></a></li>
					<li class="list-inline-item"><a href="#"><i class="fab fa-html5"></i></a></li>
					<li class="list-inline-item"><a href="#"><i class="fab fa-laravel"></i></a></li>
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="text-center text-md-left">
						<!-- avatar image -->
						<img src="images/p2.png" alt="Bolby" />
					</div>
				...
				<div class="col-md-9 triangle-left-md triangle-top-sm">
					<div class="rounded bg-dark shadow-light padding-30">
						<div class="row">
							<div class="col-md-12">
								<!-- about text -->
								<p>Tech-savvy Web Developer contributes specialty in search engine optimization, 
                                    marketing, socialmedia management and audio/video integration to launch custom-tailored code
                                     for websitepresence. Detailed understanding of complex, up-to-date programming languages 
                                     andconsiderations. Innovative approach to actualizing organizational marketing plans.
                                      Resourcefulnavigation of intricate factors governing web planning, security and launch</p>
								<div class="mt-3">
									<a href="{{ URL::to('docs/cv.pdf') }}" class="btn btn-default">Download CV</a>
								</div>
								<div class="spacer d-md-none d-lg-none" data-height="30"></div>
							</div>
